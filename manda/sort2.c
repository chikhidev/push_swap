...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/20 19:22:08 by abchikhi          #+#    #+#             */
/*   Updated: 2024/04/20 20:49:08 by abchikhi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list	*best(t_app *app, t_target *target, t_list *tmp)
{
	...
	moves = malloc(sizeof(int *) * ft_lstsize(app->stack_a->head));
	...
	reminder = cheapest(app, moves);
	free(moves);
	return (reminder);
}

void	get_route(t_app *app, t_target *target,
	t_list *min_mvs_node, int len[2])
{
